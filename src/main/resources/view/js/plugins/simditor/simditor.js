...
ColorButton = (function(_super) {
  ...
  ColorButton.prototype.renderMenu = function() {
    $('<ul class="color-list">\n  <li><a href="javascript:;" class="fonts-color fonts-color-1" data-color=""></a></li>\n  <li><a href="javascript:;" class="fonts-color fonts-color-2" data-color=""></a></li>\n  <li><a href="javascript:;" class="fonts-color fonts-color-3" data-color=""></a></li>\n  <li><a href="javascript:;" class="fonts-color fonts-color-4" data-color=""></a></li>\n  <li><a href="javascript:;" class="fonts-color fonts-color-5" data-color=""></a></li>\n  <li><a href="javascript:;" class="fonts-color fonts-color-6" data-color=""></a></li>\n  <li><a href="javascript:;" class="fonts-color fonts-color-7" data-color=""></a></li>\n  <li><a href="javascript:;" class="fonts-color fonts-color-default" data-color=""></a></li>\n</ul>').appendTo(this.menuWrapper);
    this.menuWrapper.on('mousedown', '.color-list', function(e) {
      return false;
    });
    return this.menuWrapper.on('click', '.fonts-color', (function(_this) {
      return function(e) {
        var $link, $p, hex, rgb;
        _this.wrapper.removeClass('menu-on');
        $link = $(e.currentTarget);
        if ($link.hasClass('fonts-color-default')) {
